...
* [`src/clj/library_clj/`](src/clj/library_clj/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/clj/library_clj/`](src/clj/library_clj/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/library_clj/`](src/cljs/library_clj/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/library_clj/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `library-clj` project root directory
...
in the [`src/clj/library_clj/`](src/clj/library_clj/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/library_clj/config.cljs) defaults to `true` in
